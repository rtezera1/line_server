Instructions
  ...
  The system performace as the user increase will decrease but that can be mitigated by getting better hardware. The webserver I am using, "thin", the faster, stable and most secure webserver 
  ...
  If I were a critic of my code, I would be happy about it because the code fullfills the acceptance criteria. It also has tests to ensure stability.
